//************************************************************************************
//**  
//**  File name:     D:\Skola\Mirkoracunari\LED, PWM i potenciometar 500 ms\pwm_led_potenciometar.c
//**  Title:         
//**  Description:   
//**  
//**  Generated by:  Flowcode v5.5.2.1
//**  Date:          Saturday, April 07, 2018 18:56:09
...
//U ovom zadatku smo prikazali podesavanje intenziteta svijetlosti na LED pomocu PWM modula i potenciometra, sa odredjenim kasnjenjem od 500 ms kada okrecemo potenciometar.
...
void main()
{
	...
	//Pozivamo makrokomponentu za ukljucenje PWM modula
	//Call Component Macro: Enable()
	FCD_PWM0_Enable();

	//Definisemo varijablu i njezinu pocetnu vrijednost 
	//Calculation:
	//  Napon = 255
	FCV_NAPON = 255;
	...
	while (1)
	{
		...
		//Pozivamo makro komponentu za prikaz sirinsko impulsne modulacije
		//Call Component Macro: SetDutyCycle(Napon)
		FCD_PWM0_SetDutyCycle(FCV_NAPON);

		//Intenzitet se mijenja svakih 500 ms pri okretanju potenciometra
		//Delay: 500 ms
		delay_ms(255);
		delay_ms(245);

		//Pozivamo makro komponentu da procita napon u Byte i prikazuje...
